    ...
    <main className="min-h-screen bg-white px-8 py-32 text-black transition-colors dark:bg-[#09090B] dark:text-white">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-8 max-w-3xl text-lg leading-8 text-gray-600 dark:text-gray-400">
          A modern project management application designed to
          help users organize tasks, manage workflows, and stay
          productive with a clean and intuitive interface.
        </p>
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link
            href="https://taskflow-phi-woad.vercel.app/"
            target="_blank"
